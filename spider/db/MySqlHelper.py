...
class MySqlHelper(SqlHelper):
    ...
    def __init__(self):
        ...
        self.database = mdb.connect(DB_CONFIG['dbHost'], DB_CONFIG['dbUser'], DB_CONFIG['dbPass'],DB_CONFIG['dbName'], charset='utf8')
    ...
    def createTable(self):
        self.cursor.execute("create TABLE IF NOT EXISTS %s (id INTEGER PRIMARY KEY ,ip VARCHAR(16) NOT NULL,"
               ...
               "country VARCHAR (20) NOT NULL,area VARCHAR (20) NOT NULL,updatetime TimeStamp NOT NULL DEFAULT CURRENT_TIMESTAMP,speed DECIMAL(3,2) NOT NULL)"% self.tableName)
